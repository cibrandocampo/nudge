...
from .views import subscribe, test_push, test_push_scheduled, unsubscribe, vapid_public_key
...
urlpatterns = [
    ...
    path("test/scheduled/", test_push_scheduled, name="push-test-scheduled"),
