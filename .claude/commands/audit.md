...
argument-hint: <area to audit, e.g.: "CSS design system", "inventory API", "notification models">
---
...
2. Read the relevant skills for the area being audited:
   - UI/CSS → `frontend-patterns`
   - React components/pages → `frontend-patterns`
   - Django models/views/serializers → `backend-patterns`
...
|---|------|-------|--------------------|-----------|
| 1 | `src/components/Foo.module.css` | Uses `--c-accent` | Use `--c-primary` instead | Replace token |
| 2 | ... | ... | ... | ... |
